			...
			<Fade>
				<div className='project'>
					...
					<p className='description'>
						Movie Creds is an app that focuses on one incredibly common
						question, what else were they in?
					</p>
				</div>
			</Fade>
			<Fade>
				<div className='project'>
					...
					<p className='description'>
						...
						law enforcement to the community in a public and secure manner.
						Allows all visitors to see the community's log of incidents.
					</p>
				</div>
			</Fade>
			<Fade>
